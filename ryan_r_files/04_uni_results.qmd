...
east_initial_arima_plot +
  ...
  east_initial_sarima_plot + east_tuned_sarima_plot + east_auto_plot + east_best_prophet_plot + plot_layout(ncol = 2)
```
...
as_tibble(rbind(east_initial_arima_acc,
                ...
                east_auto_acc)) %>% 
  add_row(tibble_row(MAE = east_best_prophet_mae, MASE = east_best_prophet_mase)) %>% 
...
as_tibble(rbind(midwest_initial_arima_acc,
                ...
                midwest_auto_acc)) %>% 
  add_row(tibble_row(MAE = midwest_best_prophet_mae, MASE = midwest_best_prophet_mase)) %>% 
  add_column(model = c("Initial ARIMA", "Tuned ARIMA", "Initial SARIMA", "Tuned SARIMA", "Auto ARIMA", "Prophet")) %>% 
  select(model, MAE, MASE) %>% 
...
as_tibble(rbind(south_initial_arima_acc,
                ...
                south_auto_acc)) %>% 
  add_row(tibble_row(MAE = south_season_prophet_mae, MASE = south_season_prophet_mase)) %>% 
  add_column(model = c("Initial ARIMA", "Tuned ARIMA", "Initial SARIMA", "Tuned SARIMA", "Auto ARIMA", "Prophet")) %>% 
  select(model, MAE, MASE) %>% 
...
as_tibble(rbind(west_initial_arima_acc,
                ...
                west_auto_acc)) %>% 
  add_row(tibble_row(MAE = west_best_prophet_mae, MASE = west_best_prophet_mase)) %>% 
  add_column(model = c("Initial ARIMA", "Tuned ARIMA", "Initial SARIMA", "Tuned SARIMA", "Auto ARIMA", "Prophet")) %>% 
  select(model, MAE, MASE) %>% 
