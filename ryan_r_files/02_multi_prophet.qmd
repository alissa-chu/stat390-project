---
title: "Mulivariate Prophet Model"
...
# Add some regressor 
model_regressor <- add_regressor(model_multivariate, "year")
model_regressor <- add_regressor(model_multivariate, "series_complete_moderna_65plus")
model_regressor <- add_regressor(model_multivariate, "additional_doses_12_plus")
model_regressor <- add_regressor(model_multivariate, "mmwr_week")
model_regressor <- add_regressor(model_multivariate, "season_Winter")
model_regressor <- add_regressor(model_multivariate, "administered_dos1_recip_65plus")
model_regressor <- add_regressor(model_multivariate, "additional_doses")
model_regressor <- add_regressor(model_multivariate, "month")
model_regressor <- add_regressor(model_multivariate, "administered_moderna")
model_regressor <- add_regressor(model_multivariate, "distributed")
model_regressor <- add_regressor(model_multivariate, "admin_per_100k")
model_regressor <- add_regressor(model_multivariate, "administered_pfizer")
model_regressor <- add_regressor(model_multivariate, "dist_per_100k")
model_regressor <- add_regressor(model_multivariate, "second_booster_50plus")
model_regressor <- add_regressor(model_multivariate, "region_South")
model_regressor <- add_regressor(model_multivariate, "admin_per_100k_65plus")
model_regressor <- add_regressor(model_multivariate, "second_booster_janssen")

model_regressor <- add_regressor(model_multivariate, "admin_per_100k_12plus")

# series complete_moderna_65plus
# additional_doses
# admin_per_100k
# distributed
...
future_regressor <- full_join(future_regressor, test_data, by = join_by(ds == ds))
...
# Append the regressor values
future_holiday <- left_join(future_holiday, train_data, by = join_by(ds == ds))
...
performance_holiday <- full_join(test_data, forecast_holiday2, by = join_by(ds == ds)) %>% 
  select(ds, y, yhat)
